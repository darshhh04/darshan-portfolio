      ...
      <div className="grid md:grid-cols-[1fr_2fr] gap-10">
        ...
        <div className="max-w-2xl">
          <p className="font-body text-xl md:text-2xl text-text leading-relaxed">
            [YOUR INTRODUCTION] — who you are, what kind of developer you're
            becoming, and what you enjoy building. Two or three sentences is
            plenty.
          </p>
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-8 font-mono text-sm">
            <div>
              ...
              <p className="text-text">[YOUR EDUCATION]</p>
            </div>
            <div>
              <p className="text-muted mb-2">currently</p>
              <p className="text-text">[YOUR CAREER GOAL]</p>
            </div>
          </div>
        </div>
      </div>
